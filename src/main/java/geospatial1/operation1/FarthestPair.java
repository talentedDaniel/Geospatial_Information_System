...
public final class FarthestPair {
	...
	public static void main(String[] args) throws Exception {
		SparkConf sparkConf = new SparkConf().setMaster("spark://192.168.124.131:7077").setAppName("FarthestPoint");
	    ...
	    JavaPairRDD<DataPoint,Integer> sortedPointsAsc = points.sortByKey(new TupleComparator(), true, 4);
		...
		String output="hdfs://master:54310//data//FarthestPair";
		try{
		...
		out.repartition(1).saveAsTextFile("hdfs://master:54310//data//FarthestPair");
	   // System.out.println(res3.size());
	 /*   System.out.println(res3.get(0)._2._1.x + "," + res3.get(0)._2._1.y);
	    System.out.println(res3.get(0)._2._2.x + "," + res3.get(0)._2._2.y);*/
