...
public class UnionOperation {
	...
	public static void main(String argv[]) throws IOException {
		SparkConf sparkConf = new SparkConf().setMaster("spark://192.168.124.131:7077").setAppName("Union");
		JavaSparkContext jsc = new JavaSparkContext(sparkConf);
		jsc.addJar("/home/danielvm/workspace/operation1/target/uber-operation1-0.0.1-SNAPSHOT.jar");
		JavaRDD<String> file = jsc.textFile("hdfs://master:54310//data//PolygonUnionTestData.csv", 3);
		...
		String output="hdfs://master:54310//data//Union";
		try{
		...
		res3.repartition(1).saveAsTextFile("hdfs://master:54310//data//Union");
