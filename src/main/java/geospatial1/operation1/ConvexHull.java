...
public final class ConvexHull {
	...
	public static void main(String[] args) throws Exception {
		SparkConf sparkConf = new SparkConf().setMaster("spark://192.168.124.131:7077").setAppName("ConvexHull");
		JavaSparkContext jsc = new JavaSparkContext(sparkConf);
		int default_slices=4;
	    jsc.addJar("/home/danielvm/workspace/operation1/target/uber-operation1-0.0.1-SNAPSHOT.jar");
	    JavaRDD<String> file = jsc.textFile("hdfs://master:54310//data//ConvexHullTestData.csv",default_slices);
		...
		String output="hdfs://master:54310//data//ConvexHull";
		try{
		...
		out.repartition(1).saveAsTextFile("hdfs://master:54310//data//ConvexHull");
		// Print results
